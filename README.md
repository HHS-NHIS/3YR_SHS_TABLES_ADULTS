...
This repository contains the code needed to create the interactive **NHIS Adult 3-Year Summary Health Statistics*.
The code is provided for researchers and developers interested in creating similar interactive tables, or in customizing the 3-Year SHS summary tables for personal use.
...
The **NHIS Adult 3-Year Summary Health Statistics** application is a U.S. Government work developed by the National Center for Health Statistics (NCHS).
