...
function qtr_to_num(str) {
    if (str.includes("2019-2021")) {
        str2 = str.replace("2019-2021", "2019");
    }
    // Check and replace for Jul-Dec
    else if (str.includes("2020-2022")) {
        str2 = str.replace("2020-2022", "2020");
    }
    else if (str.includes("2021-2023")) {
        str2 = str.replace("2021-2023", "2021");
    }
    else if (str.includes("2022-2024")) {
        str2 = str.replace("2022-2024", "2022");
    }
    //str2 = str.replace("2019-2021", "2019")
    //    .replace("2020-2022", "2020")
    //            .replace("2021-2023", "2021");
...
function num_to_qtr(num) {
    ...
    //str2 = str.replace("2019", "2019-2021")
    //    .replace("2020", "2020-2022")
    //    .replace("2021", "2021-2023");

    if (str.includes("2019")) {
        str2 = str.replace("2019", "2019-2021");
    }
    else if (str.includes("2020")) {
        str2 = str.replace("2020", "2020-2022");
    }
    else if (str.includes("2021")) {
        str2 = str.replace("2021", "2021-2023");
    }
    else if (str.includes("2022")) {
            str2 = str.replace("2022", "2022-2024");
    }
